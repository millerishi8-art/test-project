...
export const ERROR_MESSAGES = {
  ...
  CASES: {
    ...
    DEFERRED_DEADLINE_INVALID:
      'תאריך היעד חייב להיות מהיום ולפי המגבלות שמוצגות בטופס (למשל לפני תאריך שסוכם עם המנהל); נא לבחור תאריך חוקי.',
  },
  SERVER: {
...
/**
 * טקסטי הצהרות בעברית (טופס זכאות פוד סטאמפס) – נשמרים בתיק לאימות משפטי
 */
export const FOOD_STAMPS_DECLARATIONS_HEBREW = {
  dec1: 'הסכמה לכך שהמידע ישמש לקידום הזכאות.',
  dec2: 'הצהרה שכל הפרטים נכונים ומדויקים.',
  dec3:
    "ייפוי כוח: מתן אישור לסוכן (נועם) לפעול בשמך מול הרשויות, לקבל פרטים (כמו Social Security, דרכון וכו') ולאמת אותם.",
