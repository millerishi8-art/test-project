...
export const caseFormTranslations = {
  he: {
    ...
    paymentBankIsraelIntro:
      'העברה בנקאית בישראל — העבירו את סכום פתיחת התיק לפי הפרטים הבאים. מומלץ לציין בשדה ההערות את שמכם המלא.',
    paymentBankNameLabel: 'בנק',
    paymentBankNameValue: 'דיסקונט (11)',
    paymentBranchLabel: 'סניף',
    paymentBranchValue: 'אסף הרופא (396)',
    paymentAccountLabel: 'מספר חשבון',
    paymentAccountValue: '183280352',
    paymentHolderLabel: 'בעל החשבון',
    paymentHolderValue: 'מילר נועם',
    paymentBankUsTitle: 'תשלום מארה"ב (העברה בדולרים)',
    paymentBankUsIntro:
      'לתשלום מהארצות הברית ניתן להשתמש בשירות העברה מבוסס דוא"ל (כגון Zelle או שירות דומה), לפי הכתובת המצוינה להלן.',
    paymentBankUsVerifyTitle: 'תהליך אימות תשלום (חובה)',
    paymentBankUsVerifyBody:
      'לצורך וידוא שהכסף מגיע לחשבון הנכון, יש לבצע תחילה העברת בדיקה של דולר אחד (USD $1) בלבד. לאחר שהסוכן מאשר בכתב (בוואטסאפ או בהודעה) שהדולר התקבל — יש לשלוח את יתרת סכום פתיחת התיק. תהליך דו-שלבי זה מונע טעויות בהעברה ומגן עליכם ועלינו.',
    paymentBankUsEmailLabel: 'כתובת לשליחת התשלום',
    paymentBankUsEmail: 'millernoam77@gmail.com',
    ...
    errorWaitForUploads: 'יש קבצים שעדיין עולים. נא להמתין לסיום ההעלאה ואז לשלוח.',
    errorFileUploadFailed: 'חלק מהקבצים לא עלו. נסו להעלות אותם שוב.',
    uploadInProgressNotice: 'מעלה כעת {{count}} קבצים. אפשר להמשיך למלא את הטופס.',
    uploadingLabel: 'מעלה...',
    uploadFailedLabel: 'נכשל',
  ...
  en: {
    ...
    paymentBankIsraelIntro:
      'Bank transfer within Israel — send the case opening fee using the details below. Please include your full name in the transfer reference.',
    paymentBankNameLabel: 'Bank',
    paymentBankNameValue: 'Discount Bank (11)',
    paymentBranchLabel: 'Branch',
    paymentBranchValue: 'Asaf HaRofe (396)',
    paymentAccountLabel: 'Account number',
    paymentAccountValue: '183280352',
    paymentHolderLabel: 'Account holder',
    paymentHolderValue: 'Miller Noam',
    paymentBankUsTitle: 'Payment from the U.S. (USD transfer)',
    paymentBankUsIntro:
      'For payments from the United States, use an email-based transfer service (such as Zelle or a similar service) to the address below.',
    paymentBankUsVerifyTitle: 'Payment verification process (required)',
    paymentBankUsVerifyBody:
      'To confirm that funds are sent to the correct account, please first send a test transfer of USD $1 only. Once the agent confirms in writing (via WhatsApp or message) that the dollar was received, send the remaining opening-fee balance. This two-step process helps prevent transfer errors and protects both parties.',
    paymentBankUsEmailLabel: 'Send payment to',
    paymentBankUsEmail: 'millernoam77@gmail.com',
    paymentAppsTitle: 'Paybox / Bit',
    ...
    errorWaitForUploads: 'Some files are still uploading. Please wait and submit after uploads finish.',
    errorFileUploadFailed: 'Some files failed to upload. Please upload them again.',
    uploadInProgressNotice: 'Uploading {{count}} files now. You can keep filling the form.',
